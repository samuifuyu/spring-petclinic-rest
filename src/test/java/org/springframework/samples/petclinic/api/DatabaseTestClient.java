...
public class DatabaseTestClient {
	...
	public Long insert(String table, String column, String value) throws SQLException {
		PreparedStatement statement = connection.prepareStatement(
				String.format("INSERT INTO %s(%s) VALUES(?)", table, column), Statement.RETURN_GENERATED_KEYS);
	...
	public void delete(String table, Long id) throws SQLException {
		PreparedStatement statement = connection.prepareStatement(String.format("DELETE from %s where id = ?", table));
	...
	public String selectById(String table, Long id) throws SQLException {
		PreparedStatement statement = connection
				.prepareStatement(String.format("SELECT * from %s where id = ?", table));
		statement.setLong(1, id);
